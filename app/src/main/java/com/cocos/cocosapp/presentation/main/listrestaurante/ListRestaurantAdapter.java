...
public class ListRestaurantAdapter extends LoaderAdapter<RestauranteResponse> implements OnClickListListener {


    private Context context;
    private RestItem restItem;

    public ListRestaurantAdapter(ArrayList<RestauranteResponse> restEntinties, Context context, RestItem restItem) {
        super(context);
    ...
    public ListRestaurantAdapter(ArrayList<RestauranteResponse> restEntinties, Context context) {
        super(context);
        setItems(restEntinties);
        this.context = context;
    }
